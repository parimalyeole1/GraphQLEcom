...
export function ShoppingCartIcon() {
  ...
  return (
    <div className="group relative">
      ...
      <span
        className="translate absolute bottom-0 left-0 inline-flex translate-y-[50%] translate-x-[-50%] items-center justify-center rounded-full bg-black px-[0.25rem] py-[0.125rem] text-xs text-white"
        style={{
          lineHeight: "0.75rem",
        }}
      >
